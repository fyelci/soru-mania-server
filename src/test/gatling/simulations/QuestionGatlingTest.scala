...
class QuestionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Question entity")
        ...
        .repeat(2) {
            ...
            .post("/api/questions")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "detail":"SAMPLE_TEXT", "mediaUrl":"SAMPLE_TEXT", "commentCount":"0", "createDate":"2020-01-01T00:00:00.000Z", "lastModifiedDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
