...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "SoruMania@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "SoruMania API";

        private String description = "SoruMania API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "SoruMania";
